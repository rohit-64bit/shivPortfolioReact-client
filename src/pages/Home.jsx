...
function Home() {
    ...
    return (
        <>
            ...
            <div className='h-max bg-slate-100 flex flex-col gap-5 lg:gap-0 md:flex-row justify-between p-8 md:p-10 lg:py-20'>
                <div className='m-auto'>
                    <img src={shibDas} alt="" className='shadow-md md:shadow-lg shadow-slate-600' />
                </div>
                <div className='m-auto lg:w-[60%]'>
                    <p className='text-2xl lg:text-3xl font-serif text-slate-600'>Enthusiastic educator and Machine Learning developer.</p>
