...
function AdminBlogEdit() {
  ...
  return (
    <>
      ...
      <div>
        <form className='p-5 md:p-20 flex flex-col gap-5'>
          <div className='flex'>
            <div>
          ...
          <button className='w-full bg-blue-900 hover:bg-sky-500 py-3 font-bold text-white text-lg transition-all ease-in-out duration-300 hover:shadow-lg shadow-slate-400' onClick={updateBlog} type='submit'>SAVE BLOG</button>
        </form>
      </div>
    </>
  )
