    ...
    return (
        <>
            <div className='py-24 bg-slate-200'>
                ...
                <form className='w-full md:w-[30%] flex flex-col mx-auto justify-items-center gap-5 p-5'>
                    ...
                    <button onClick={handleAdminLogin} className='w-full bg-blue-900 hover:bg-sky-500 py-3 font-bold text-white text-lg transition-all ease-in-out duration-300 hover:shadow-lg shadow-slate-400'>LOGIN</button>
