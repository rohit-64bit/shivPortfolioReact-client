    ...
    return (
        <>
            <div className='md:w-[18rem] h-[91vh] flex flex-col gap-4 bg-slate-100 p-2'>
                ...
                <NavLink className={({ isActive }) => (isActive ? 'bg-blue-900 shadow-lg text-white font-medium md:px-5 md:py-2 p-2 rounded-md' : 'bg-white md:px-5 md:py-2 p-2 rounded-md hover:bg-blue-200 hover:shadow-lg transition-all ease-in-out duration-300 text-slate-500 hover:text-slate-700')} to="/admin/contactrequest" ><ManageAccountsIcon /><span className='hidden md:inline my-auto'> Account Settings</span></NavLink>
                ...
                >
                    <div className='bg-white p-10 w-max h-max space-y-5 rounded-md shadow-lg'>
                        <div className='font-bold'>Confirm Logout</div>
                        <div className='space-x-5'><button onClick={handleLogout} className='bg-red-600 px-4  py-2 hover:bg-red-800 text-white font-semibold transition-all ease-in-out duration-300 rounded hover:shadow-md'>Logout</button><button onClick={handleClose} className='bg-blue-600 px-4  py-2 hover:bg-blue-900 text-white font-semibold transition-all ease-in-out duration-300 rounded hover:shadow-md'>Cancel</button></div>
                    </div>
                </Modal>
            </div>
        </>
